...
module "apim" {
    ...
    excluded_log_types = ["DataPlaneRequests"]
}
...
module "apim_echo_api" {
    ...
    content_value = file("../../modules/openapi/Echo_API.json") # Jan 1st, 2024
    path = "echo"
    protocols = ["https"]
...
module "apim_echo_api_v2" {
    ...
    api_management_name = module.apim.name
    # content_format = "openapi+json"
    # content_value = file("../../modules/openapi/Echo_API.json") # June 1st, 2023 - Copy Operation happened here
    path = "echo"
    protocols = ["https"]

    source_api_id = "something"

    # subscription_required = true
}


# January 1st, 2024 - new prod deployment
